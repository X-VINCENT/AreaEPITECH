...
class ShutdownAreas extends ConsumerStatefulWidget {
  @override
  _ShutdownAreas createState() => _ShutdownAreas();

  static _ShutdownAreas of(BuildContext context) {
    final _ShutdownAreas? app =
        context.findAncestorStateOfType<_ShutdownAreas>();
    if (app == null) {
      throw FlutterError('ShutdownAreas widget not found in the widget tree');
    }
    return app;
  }
}

class _ShutdownAreas extends ConsumerState<ShutdownAreas> {
  ...
  void fillController(
      AreaController controller, Map<String, dynamic> areaService) {
    ...
    controller
        .setAction(convertMapToTextControllers(areaService['action_config']));
    controller.setReaction(
        convertMapToTextControllers(areaService['reaction_config']));
  }
                      ...
                      child: Row(
                        children: [
                          AreaSquare(
                              ...
                              color: const Color.fromRGBO(254, 175, 175, 100))
                        ],
                      ),
                    ),
                ],
